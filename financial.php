...
<html>
	<head>
		<title>Financial And Audit|SHUKHIBHAVA</title>
  ...
  <script>window.jQuery || document.write('<script src="js/jquery-1.9.1.min.js"><\/script>')</script>
    ...
    <link rel="stylesheet" href="css/example.css">
		...
		<meta name="keywords" content="Finance,Audit,business and operations,risk,economical">
		<meta name="description" content="Shukhibhava provides independent and objective view on both 
		the first (business and operations) and second (risk and compliance) lines of defense">
		<script>
		 	...
		 	<div class="blog">
		 		...
		 		<div class="single-page-artical">
								<div class="artical-content">
									<center><img src="images/pic7.jpg" title="banner1"></center>
									<p>Shukhibhava provides independent and objective view on both the first (business and operations) and second (risk and compliance) lines of defense. From being a transaction and compliance oriented function. Internal Audit function is expected to evaluate emerging risk areas and perform thematic and targeted reviews with a view to assess not just the efficacy of controls but probability of the risks materializing in the given organizational construct.<br><br>

A relatively uncertain economic environment has put significant pressure on debt servicing capabilities of corporates. It has also created a need to critically assess the existing portfolio and take an account of the related risk management and accounting practices. This situation, coupled with the uncertain economic environment and increased global regulatory scrutiny will require financial institutions to critically evaluate the quality of their regulatory submissions, model risk, capital related computations and conduct in the financial markets. There is also likely to be an increased focus on conduct with customers and fairness in dealings.<br><br> Based on the aforesaid developments and emerging trends, the focus areas for Internal Audit<br>
Shukhibhava enables efficient and effective management of money (funds) in such a manner as to accomplish the objectives of the organization. It is the specialized function directly associated with the top management. The significance of this function is not seen in the 'Line' but also in the capacity of 'Staff' in overall of a company<br>
