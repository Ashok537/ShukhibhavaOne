...
<html>
	<head>
		<title>MANPOWERSOLUTIONS|SHUKHIBHAVA</title>
  ...
  <script>window.jQuery || document.write('<script src="js/jquery-1.9.1.min.js"><\/script>')</script>
    ...
    <link rel="stylesheet" href="css/example.css">
		...
		<meta name="keywords" content="innovative workforce,man power,clients,business goals,recruitment ">
		<meta name="description" content="We create and delivers 
		high-impact solutions that enable our clients to achieve their business goals and enhance their competitiveness">
		<script>
		 	...
		 	<div class="blog">
		 		...
		 		<div class="single-page-artical">
								<div class="artical-content">
									...
									<center><img src="images/pic6.jpg" title="banner1"></center>
									<p>Leader in innovative workforce solutions,  creates and delivers high-impact solutions that enable our clients to achieve their business goals and enhance their competitiveness. These solutions cover an entire range of talent-driven needs from recruitment and assessment, training and development, and career management, to outsourcing and workforce consulting.<br><br>
Recruitment and retention are critical to sustain companys Armed Forces with the best men willing to stand in the gap & ensure best results. Social & Professional networking sites are increasingly becoming a very strong place for companies to develop their talent & recruitment plans and so there are ways in which we track some of the momentum there. <br><br>

Shukhibhava  stand out & perform at the best, support critical needs & ensure closure within the SLAs
IMC is backed with ERP tool which provides an outstanding difference among other consulting in addition to the strategic sourcing as a value addition.Which will help the client in cost saving towards recruitment & Performing at the best possible by meeting SLAs in time. <br>
									</p>
								    </div>
