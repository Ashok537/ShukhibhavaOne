...
<html>
	<head>
		<title>PROJECT MANAGEMENT|SHUKHIBHAVA</title>
  ...
  <script>window.jQuery || document.write('<script src="js/jquery-1.9.1.min.js"><\/script>')</script>
    ...
    <link rel="stylesheet" href="css/example.css">
		...
		<meta name="keywords" content="project management,Planning,manage multiple projects and teams,hospital,Accountability">
		<meta name="description" content="Shukhibhava will initiate, plan, execute, Control & Close the work of a team in a desired timeline">
		 	...
		 	<div class="blog">
		 		...
		 		<div class="single-page-artical">
								<div class="artical-content">
									<center><img src="images/slider4.jpg" title="banner1"></center>
									<p> We will initiate, plan, execute, Control & Close the work of a team in a desired timeline. Built To Scale & Drive Results. Unite Planning With Execution. Keeps the Team in Harmony. We will give you the flexibility you need to manage multiple projects and teams in one tool. <br>
										Shukhibhava enables the application of processes, methods, knowledge, skills and experience to achieve the project objectives. General. A project is a unique, transient endeavor, undertaken to achieve planned objectives, which could be defined in terms of outputs, outcomes or benefits. <br>
										-	Local Knowledge In-depth<br>
										-	Process Based Management System<br>
										-	Sharing Global Best Practices<br>
										-	Accountability and Ownership on every assignment<br>
										-	Technically Capable and Dedicated Project Team for every assignment<br>
										-	Senior Management Involvement on every project<br>
										-	Successful Delivery Strategies<br>
