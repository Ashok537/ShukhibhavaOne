...
<html>
	<head>
		<title>MEDIA SOLUTIONS|SHUKHIBHAVA</title>
  ...
  <script>window.jQuery || document.write('<script src="js/jquery-1.9.1.min.js"><\/script>')</script>
    ...
    <link rel="stylesheet" href="css/example.css">
		...
		<meta name="keywords" content="technology,media company,design,talented team of creative directors,creative">
		<meta name="description" content="We generate the ideas and build the technology that transform how businesses manage design.">
		<script>
		 	...
		 	<div class="blog">
		 		...
		 		<div class="single-page-artical">
								<div class="artical-content">
									...
									<center><img src="images/pic5.jpg" title="banner1"></center>
									<p>we deliver design for print and digital to retailers and media companies worldwide.<br><br>
										We generate the ideas and build the technology that transform how businesses manage design. <br><br>
										We are specialized in film making, Tv commercials and other advertisements. <br><br>
										SHUKHIBHAVA is a Hyderabad based visual communication firm offering video production & broadcast services. We specializes in making Corporate Films, Commercials, Audio Visuals, Social Documentaries and covering live stage shows with Multi Camera Setups. <br><br>
										Since 2009, we've been providing our expertise and the services that our clients need to be successful in the highly competitive business world. With strong industry alliances, in-house production and post-production facilities, we are capable of delivering International quality service with more production value. Our experience, technical expertise and personal approach has made us the first choice for companies of all sizes. We have been working with clients across India, helping them attain an entirely new level of fineness through our services. <br>
										We consider film making to be an art form. Outstanding films cannot be made without clear vision and the direction. We utilize creative and intelligent cinematography in the making of our films. We make every effort to bring back to the screen, the feelings and emotions of the story, day or event. We recommend coming to us with a clear idea of your objectives and your audience, and allow us to come up with a concept which will best communicate your ideas. <br><br>
										At SHUKHIBHAVA, we know that the success of our business is directly related to the success of our customers. We listen carefully and respond quickly to the needs of our customers and constantly expand services and the delivery quality standards. We help you visualise your company's objective & aim into a quality video with best of content and visual treatment. <br><br>
										SHUKHIBHAVA's mission is to facilitate its clients in achieving their creative goals. Our experienced and talented team of creative directors, script writers, production coordinators, video editors, cameramen… all strives to bring in a unique perspective and maximum return to any project, large or small. We offer a genuine end-to-end solution from pre-production to final delivery including pre-visualization, equipment hire, visual effects, video and audio post-production. <br><br>
