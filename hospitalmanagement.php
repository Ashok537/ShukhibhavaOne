...
<html>
	<head>
		<title>HOSPITAL MANAGEMENT|SHUKHIBHAVA</title>
  ...
  <script>window.jQuery || document.write('<script src="js/jquery-1.9.1.min.js"><\/script>')</script>
	...
	<script>
		...
		<meta name="keywords" content="health care,Hospital management,Clinical Operations,Accounting/Finance, enhance quality">
		<meta name="description" content="Shukhibhava's services are designed to enhance quality and increase efficiency
		at the health care facility level">
		 	...
		 	<div class="blog">
		 		...
		 		<div class="single-page-artical">
								<div class="artical-content">
									<center><img src="images/slider1.jpg" title="banner1"></center>
									<p> Hospital management services are designed to enhance quality and increase efficiency at the health care facility level. A team of professionals assists facilities with the following services<br><br>
										Clinical Operations<br> 
										-	Risk management compliance consisting of benchmarking clinical outcomes<br><br>
										Accounting/Finance<br> 
										-	Automated AP workflow processes between facilities and company headquarters<br> 
										-	Financial analysis, performance benchmarking, financial projections<br><br>
										Purchasing<br> 
										-	Group Purchasing Organization (GPO) data warehousing, compliance tracking and facilitation of national agreements
										Health Information Technology<br> 
										-	Centralized data management, backup and storage<br> 
										-	24-hour automated monitoring of data connections<br> <br>
										Human Resources<br> 
										-	Benefit management including health care, flexible spending, 401K and life and disability insurance<br> 
										-	Payroll services including processing, garnishments, time and attendance and employment verification<br><br>
										Legal<br> 
										-	Litigation support and management<br> 
										-	Regulatory compliance<br> 
										-	Contract Review<br> 
										-	Transactional matters and organizational matters including entity formation and reporting<br><br>
										Marketing<br> 
										-	Supervision of branding and implementation of marketing and community awareness campaigns<br> 
										-	Implementation of focused promotions using marketing and PR expertise<br><br>
										Centralized Business Office<br> 
										-	Full-time professionals in benefit verification, patient financial counseling, coding, billing and collections.
